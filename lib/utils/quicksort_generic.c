...
int partition(comparable collection[], const int low, const int high,
...
void quicksort(comparable collection[], const int low, const int high,
               int (*compare)(comparable, comparable)) {
    if (low < high) {
...
void sort(comparable collection[], const int size,
          int (*compare)(comparable, comparable)) {
